...
var TABLE_RULES_PROPERTY = "tableRules";
SelectQueryRules = (function () {
    ...
    SelectQueryRules.toString = function (rules) {
        var afterWhere = "";
        var _orderbyClause = "";
        var _groupByClause = rules.groupByColumn.length > 1 ? " GROUP BY " + Helper.toRowProperty(rules.groupByColumn) + " " : "";
...
SelectQueryRules.TABLE_RULES_PROPERTY = TABLE_RULES_PROPERTY;